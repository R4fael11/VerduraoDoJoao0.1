...
namespace VerduraoDoJoao01
{
    class Program
    {
...

        {
            ...
            {
                Console.WriteLine("Boa Segunda Feira!");
            }
            else if (diaDaSemana == "Tuesday")
            {
                Console.WriteLine("Terça-Feira Verde (produtos com 15% de desconto!! )");
            }
            else if (diaDaSemana == "Wednesday")
            {
                Console.WriteLine("Quarta-Feira Verde (produtos com 17% de desconto!! ");
            }
            else if (diaDaSemana == "Thursday")
            {
                Console.WriteLine("As Quintas-Feiras temos 2% de desconto em nossos produtos!");
            }
            else if (diaDaSemana == "Friday")
            {
                Console.WriteLine("As Sextas-Feiras temos 3% de desconto em nossos produtos!");
